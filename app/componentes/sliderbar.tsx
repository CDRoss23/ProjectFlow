...
const Sliderbar = () => {
  ...
  const menuItems = {
    ...
    gerente: [
      ...
      {
        href: "/gerente/gestionar-proyectos",
        icon: <AiOutlineProject size={24} />,
        label: "Gestionar Proyectos",
      },
      {
        href: "/gerente/proceso",
        icon: <AiOutlineTeam size={24} />,
        label: "Supervisar Proyecto",
      },
      {
        href: "/gerente/comunicacion",
        icon: <AiOutlineTeam size={24} />,
        label: "Comunicacion",
      },
    ],
